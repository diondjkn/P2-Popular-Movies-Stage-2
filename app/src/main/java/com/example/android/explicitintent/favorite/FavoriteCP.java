...
import static com.example.android.explicitintent.favorite.FavoriteContract.AUTHORITY;
import static com.example.android.explicitintent.favorite.FavoriteContract.BASE_CONTENT_URI;
import static com.example.android.explicitintent.favorite.FavoriteContract.FavoriteMovieEntry.TABLE_NAME;

public class FavoriteCP extends ContentProvider {
    ...
    public boolean onCreate() {
        dbHelper = new FavoriteDbH(getContext());
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (match) {
            case FAVORITE_MOVIES: {
                ...
                if (id > 0) {
                    insertUri = FavoriteContract.FavoriteMovieEntry.buildMovieUri(String.valueOf(id));
                } else {
